...
namespace ProyectBar
{
    public partial class Observacion : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Debe ingresar una observacion para guardar", "Alerta!");
            }
        }
        ...
        public void InsertarLetra(string letra)
        {
            ...
            try
            {
                ...
                {
                    txtObservacion.Text = "";
                    txtObservacion.Text = letra;
                    secuencia = false;

                }
                else
                {
                    txtObservacion.Text = txtObservacion.Text + letra;
                }
            }
            catch
            {
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtObservacion.Text.Count() == 0)
                {
                    MessageBox.Show("El campo seleccionado no contiene caracteres para borrar", "Error");
                }
                else
                {
                    txtObservacion.Text = txtObservacion.Text.Substring(0, txtObservacion.Text.Count() - 1);
                }
            }
            catch
            {
