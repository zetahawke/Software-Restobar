   ...
   public class NegocioBodegaCentral
    {
        ...
        {
            this.cnn._nombreTabla = "BodegaCentral";
            this.cnn._user = "";
            this.cnn._password = "";
        ...
        public void insertarBodegaCentral(BodegaCentral cli)
        {
            this.configConex();
        ...
        public System.Collections.ArrayList getBodegaCentral()
        {
            ...
            {
                BodegaCentral ca = new BodegaCentral();
                ca._ID_BodegaCentral = int.Parse(dr["ID_BodegaCentral"].ToString());
        ...
        public BodegaCentral buscarBodegaCentral(int idCliente)
        {

            BodegaCentral cli = new BodegaCentral();
            this.configConex();
            this.cnn._sentenciaSQL = "Select * from " + cnn._nombreTabla + " where ID_BodegaCentral = " + idCliente;
            this.cnn._esSelect = true;
            this.cnn.conectar();
        ...
        public void modificarBodegaCentral(BodegaCentral cli)
        {
            this.configConex();
            this.cnn._sentenciaSQL = "update " + cnn._nombreTabla +
                        " set ID_BodegaCentral=" + cli._ID_BodegaCentral + "," +
                        "Ingrediente=" + cli._ingrediente + "," +
                        "Cantidad=" + cli._cantidad + 
                        " where ID_BodegaCentral=" + cli._ID_BodegaCentral;
        ...
        public void eliminarBodegaCentral(int idCliente)
        {
            ...
            this.cnn._sentenciaSQL = "Delete from " + cnn._nombreTabla +
                        " where ID_BodegaCentral=" + idCliente;
            this.cnn._esSelect = false;
            this.cnn.conectar();
            this.cnn.cerrarConexion();
        }
